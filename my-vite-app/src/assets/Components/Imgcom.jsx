...
const Imgcom = ({data}) => {
   ...
   return (
    <div >
      {data.map((item , index) =>(
<div className="mx-md-5 my-5" key={index}>
{item.show1 && 
    <div className=' display my-5 footer-class about-class1 p-1 mx-md-5 bg-warning shadow'  >
        ...
        <div style={{marginTop:"30px", marginBottom:"40px"}}>
          <img  style={{height:"500px", marginRight:"30px"}} src={item.image} alt="error" />
        </div>
...
{item.show2 && 
    <div className='footer-class about-class1 display my-5 p-1 mx-5 about-com' style={{ boxShadow:"1px 2px 8px rgb(190, 161, 29)"}} >
        <div   style={{marginTop:"20px", marginBottom:"30px"}}>
             <img style={{height:"500px", marginLeft:"10px"}} src={item.image} alt="error" />
